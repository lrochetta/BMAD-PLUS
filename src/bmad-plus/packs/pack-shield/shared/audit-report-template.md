...
> 🤖 **AI-GENERATED DRAFT — Not legal advice.** Produced with BMAD+ Shield (AI-assisted). Requires review and sign-off by a qualified person (lawyer, DPO or certified auditor) before use. Keep this banner on every copy.
...
| **Generation** | AI-generated draft — human review required |
| **Reviewed by (qualified person)** | [NAME, ROLE, DATE] |
