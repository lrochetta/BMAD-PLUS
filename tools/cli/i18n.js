...
const LANGUAGES = {
  en: {
    ...
    uat_environment: 'Test environment for human acceptance recipes (URL, blank if none)',
    ...
    noninteractive_requires_yes: (command) =>
      'This command requires a terminal. Run `npx bmad-plus ' +
      command +
      ' --yes` to proceed without prompts.',
    ...
    uninstall_preserved:
      'Project memory, settings, and unknown or modified files have been preserved.',
    ...
    guide_example_memory_1: '🧠 Memory: "Zecher, scan projects in ~/projects"',
  ...
  fr: {
    ...
    uat_environment: 'Environnement de test pour les recettes humaines (URL, vide si aucun)',
    ...
    noninteractive_requires_yes: (command) =>
      'Cette commande nécessite un terminal. Lancez `npx bmad-plus ' +
      command +
      ' --yes` pour continuer sans invite.',
    manifest_invalid: (error) =>
      'Le manifeste d’installation est illisible ou corrompu : ' + error + '',
    ...
    uninstall_preserved:
      'La mémoire, les réglages et les fichiers inconnus ou modifiés ont été conservés.',
    ...
    guide_dev_studio: '🏗️ Dev Studio',
    guide_example_memory_1: '🧠 Mémoire : "Zecher, scanne les projets dans ~/projects"',
  ...
  es: {
    ...
    uat_environment: 'Entorno de pruebas para las recetas de aceptación (URL, vacío si no hay)',
    ...
    guide_example_shield_2:
      '\ud83d\udee1\ufe0f GRC: "Shield, an\u00e1lisis de brechas ISO 27001 vs NIST CSF"',
    guide_example_shield_3:
      '\ud83d\udee1\ufe0f GRC: "Shield, genera checklist de evidencias SOC 2"',
    ...
    noninteractive_requires_yes: (command) =>
      'Este comando requiere una terminal. Ejecute `npx bmad-plus ' +
      command +
      ' --yes` para continuar sin preguntas.',
    manifest_invalid: (error) =>
      'El manifiesto de instalación no se puede leer o está dañado: ' + error + '',
    ...
    uninstall_preserved:
      'Se han conservado la memoria, los ajustes y los archivos desconocidos o modificados.',
    ...
    guide_dev_studio: '🏗️ Dev Studio',
    guide_example_memory_1: '🧠 Memoria: "Zecher, escanea proyectos en ~/projects"',
    guide_example_memory_2: '🧠 Memoria: "Zecher, ¿dónde estábamos?"',
    guide_example_memory_3: '🧠 Memoria: "Zecher, consolida la memoria"',
    guide_example_dev_studio_1:
      '🏗️ Dev Studio: "Miriam, haz una lluvia de ideas para una app de productividad"',
  ...
  de: {
    ...
    uat_environment: 'Testumgebung für menschliche Abnahmen (URL, leer wenn keine)',
    ...
    guide_shield: '\ud83d\udee1\ufe0f GRC-Compliance',
    guide_example_shield_1:
      '\ud83d\udee1\ufe0f GRC: "Shield, pr\u00fcfe meine App auf DSGVO-Konformit\u00e4t"',
    ...
    guide_credits:
      '✨ BMAD+ wurde erstellt von Laurent Rochetta — github.com/lrochetta/BMAD-PLUS ✨',
    uninstall_confirm: 'BMAD+ aus diesem Projekt entfernen?',
    noninteractive_requires_yes: (command) =>
      'Dieser Befehl benötigt ein Terminal. Führen Sie `npx bmad-plus ' +
      command +
      ' --yes` aus, um ohne Rückfragen fortzufahren.',
    manifest_invalid: (error) =>
      'Das Installationsmanifest ist unlesbar oder beschädigt: ' + error + '',
    manifest_repair:
      'Prüfen und reparieren Sie _bmad/.bmad-plus-install.json vor einem erneuten Versuch.',
    ...
    uninstall_preserved:
      'Projektspeicher, Einstellungen sowie unbekannte oder geänderte Dateien wurden erhalten.',
    ...
    guide_dev_studio: '🏗️ Dev Studio',
    guide_example_memory_1: '🧠 Gedächtnis: "Zecher, scanne Projekte in ~/projects"',
  ...
  'pt-br': {
    ...
    uat_environment:
      'Ambiente de teste para receitas de aceitação humana (URL, vazio se não houver)',
    ...
    guide_example_shield_2:
      '\ud83d\udee1\ufe0f GRC: "Shield, an\u00e1lise de lacunas ISO 27001 vs NIST CSF"',
    guide_example_shield_3:
      '\ud83d\udee1\ufe0f GRC: "Shield, gere checklist de evid\u00eancias SOC 2"',
    ...
    noninteractive_requires_yes: (command) =>
      'Este comando exige um terminal. Execute `npx bmad-plus ' +
      command +
      ' --yes` para continuar sem perguntas.',
    manifest_invalid: (error) =>
      'O manifesto de instalação está ilegível ou corrompido: ' + error + '',
    ...
    uninstall_preserved:
      'A memória, as configurações e os arquivos desconhecidos ou modificados foram preservados.',
    ...
    guide_dev_studio: '🏗️ Dev Studio',
    guide_example_memory_1: '🧠 Memória: "Zecher, escaneie projetos em ~/projects"',
    guide_example_memory_2: '🧠 Memória: "Zecher, onde estávamos?"',
    guide_example_memory_3: '🧠 Memória: "Zecher, consolide a memória"',
    guide_example_dev_studio_1:
      '🏗️ Dev Studio: "Miriam, faça um brainstorm de um app de produtividade"',
  ...
  ru: {
    ...
    uat_environment: 'Тестовая среда для ручной приёмки (URL, пусто если нет)',
    ...
    noninteractive_requires_yes: (command) =>
      'Для этой команды нужен терминал. Запустите `npx bmad-plus ' +
      command +
      ' --yes`, чтобы продолжить без запросов.',
    manifest_invalid: (error) => 'Манифест установки недоступен или повреждён: ' + error + '',
    manifest_repair:
      'Проверьте и исправьте _bmad/.bmad-plus-install.json перед повторной попыткой.',
    ...
    guide_dev_studio: '🏗️ Dev Studio',
    guide_example_memory_1: '🧠 Память: "Zecher, сканируй проекты в ~/projects"',
  ...
  zh: {
    ...
    comm_language: '沟通语言',
    uat_environment: '人工验收的测试环境（URL，没有则留空）',
    exec_mode: '执行模式',
    ...
    noninteractive_requires_yes: (command) =>
      '此命令需要终端。运行 `npx bmad-plus ' + command + ' --yes` 可跳过提示并继续。',
    ...
    guide_memory: '🧠 持久记忆',
    guide_dev_studio: '🏗️ Dev Studio',
    guide_example_memory_1: '🧠 记忆: "Zecher, 扫描 ~/projects 中的项目"',
  ...
  he: {
    ...
    uat_environment: 'סביבת בדיקה לבדיקות קבלה אנושיות (כתובת URL, ריק אם אין)',
    exec_mode: 'מצב ביצוע',
    ...
    noninteractive_requires_yes: (command) =>
      'פקודה זו דורשת מסוף. להרצה ללא שאלות, הפעילו `npx bmad-plus ' + command + ' --yes`.',
    ...
    guide_dev_studio: '🏗️ Dev Studio',
    guide_example_memory_1: '🧠 זיכרון: "Zecher, סרוק פרויקטים ב-~/projects"',
  ...
  ja: {
    ...
    uat_environment: '人による受け入れ確認のテスト環境（URL、なければ空欄）',
    exec_mode: '実行モード',
    ...
    guide_credits:
      '✨ BMAD+ は Laurent Rochetta によって作成されました — github.com/lrochetta/BMAD-PLUS ✨',
    uninstall_confirm: 'このプロジェクトからBMAD+を削除しますか？',
    noninteractive_requires_yes: (command) =>
      'このコマンドには端末が必要です。確認なしで続行するには `npx bmad-plus ' +
      command +
      ' --yes` を実行してください。',
    ...
    uninstall_preserved:
      'プロジェクトの記憶、設定、不明なファイルや変更されたファイルは保持されました。',
    ...
    guide_memory: '🧠 永続的な脳',
    guide_dev_studio: '🏗️ Dev Studio',
    guide_example_memory_1: '🧠 記憶: "Zecher, ~/projects のプロジェクトをスキャン"',
  ...
  it: {
    ...
    uat_environment:
      'Ambiente di test per le verifiche di accettazione umana (URL, vuoto se nessuno)',
    ...
    noninteractive_requires_yes: (command) =>
      'Questo comando richiede un terminale. Eseguire `npx bmad-plus ' +
      command +
      ' --yes` per continuare senza domande.',
    manifest_invalid: (error) =>
      'Il manifesto di installazione è illeggibile o danneggiato: ' + error + '',
    ...
    uninstall_preserved:
      'La memoria, le impostazioni e i file sconosciuti o modificati sono stati conservati.',
    ...
    guide_dev_studio: '🏗️ Dev Studio',
    guide_example_memory_1: '🧠 Memoria: "Zecher, scansiona progetti in ~/projects"',
    guide_example_memory_2: '🧠 Memoria: "Zecher, dove eravamo?"',
    guide_example_memory_3: '🧠 Memoria: "Zecher, consolida la memoria"',
    guide_example_dev_studio_1:
      '🏗️ Dev Studio: "Miriam, fai un brainstorming di un\'app di produttività"',
