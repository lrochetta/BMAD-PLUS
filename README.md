...
2. Propose les packs à installer (Core, OSINT, Audit)
...
- **ai_analyzer.py** — Classification IA (Gemini 2.0 Flash)
...
| `install_packs` | Packs installés | core, osint, audit, all |
...
|---------|------|-------------|
| **0.1.0** | 2026-03-17 | 🎉 Foundation — 5 agents (Atlas, Forge, Sentinel, Nexus, Shadow), 3 skills (autopilot, parallel, sync), pack system, monitoring, multi-IDE support |
